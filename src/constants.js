...
export const APP_NAME = 'NarrativeDeX'
export const DESCRIPTION =
  'NarrativeDeX is a composable, decentralized, and permissionless platform to collaborate with writers and create user-owned content. Built with Lens 🌿'
export const DEFAULT_OG = 'https://assets.lenster.xyz/images/og/logo.jpeg' // TODO: Need to change

// Git
export const GIT_COMMIT_SHA =
  process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA?.slice(0, 7) // TODO: Need to change
export const GIT_COMMIT_REF = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_REF // TODO: Need to change

// Misc
export const CONTACT_EMAIL = 'support@lenster.xyz' // TODO: Need to change
export const PUBLIC_URL = process.env.NEXT_PUBLIC_URL // TODO: Need to change
export const RELAY_ON =
  PUBLIC_URL === 'https://lenster.xyz' || PUBLIC_URL === 'http://localhost:4783' // TODO: Need to change
...
// Web3
export const ALCHEMY_KEY_MAINNET = process.env.NEXT_PUBLIC_ALCHEMY_KEY_MAINNET
export const ALCHEMY_KEY_TESTNET = process.env.NEXT_PUBLIC_ALCHEMY_KEY_TESTNET

export const ALCHEMY_RPC = IS_MAINNET
  ? `https://polygon-mainnet.g.alchemy.com/v2/${ALCHEMY_KEY_MAINNET}`
  : `https://polygon-mumbai.g.alchemy.com/v2/${ALCHEMY_KEY_TESTNET}`
